              ...
              <div class="card-body p-4">
                ...
                <div class="table-responsive">
                  <table class="table text-nowrap mb-0 align-middle">
                    ...
                    <tbody>
                    <?php $no = 1; ?>
                        <?php $query = mysqli_query($conn, "SELECT * FROM pengaduan LEFT JOIN masyarakat ON pengaduan.nik=masyarakat.nik LEFT JOIN tanggapan ON pengaduan.id_pengaduan=tanggapan.id_pengaduan LEFT JOIN petugas ON tanggapan.id_petugas=petugas.id_petugas ORDER BY tanggapan.tgl_tanggapan ASC"); ?>
                    <?php while ($result = mysqli_fetch_array($query)) : ?>
                        <tr>
                            <td><?php echo $no++; ?></td>
                            <td><?php echo $result['nama']; ?></td>
                            <td><?php if($result['nama_petugas'] == ''){echo"-";}else{echo $result['nama_petugas'];} ?>
